...
pubcoder.page.id = pubcoder.page.id || 806;
...
obj1005_onTap_actionGroup0 = function(){
	...
	if (isLastActionGroup) {
		...
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			...
			if (evt.senderObjectId == 1005) {
				console.warn("de-queueing event obj1005." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj1005").trigger(evt.eventName);
				return;
			}
		}
		return;
...
function playAudioFile_1021() {
	...
	if (useReader) {
		if (waitForCompletion) {
			XPUB.playAudio(myAudio.src, playFromBeginning, "obj_audio_playSoundFile1021");
			$("#obj_audio_playSoundFile1021").one('ended', function() {
...
if (window.obj1005_onTap_runningActionsCount < 0) {
	window.obj1005_onTap_runningActionsCount = 0;
} else if (window.obj1005_onTap_runningActionsCount == 0) {
...
obj1005_onTap_actionGroup2 = function(){
	...
	window.obj1005_onTap_activeActionGroupIndex = 2;
...
$("#obj1005").bind(PubCoder.Events.Tap, function(event) {
	...
	if (window.obj1005_onTap_activeActionGroupIndex != -1) {
	console.warn("action list window.obj1005_onTap is still running");
	return;
}
var obj1005_onTap_runningActionsCount = 0;
var obj1005_onTap_loopCount = 0;
